...
#define VOLUME_SIZE 1085476 //4096+32768+1048576 + 4 + 32
...
#define CURRENT_DIR_ADDRESS 1085472
#define ROOT_DIR_ADDRESS 36872
...
__global__ void mykernel(uchar *input, uchar *output) {
  ...
  fs_init(&fs, volume, SUPERBLOCK_SIZE, FCB_SIZE, FCB_ENTRIES, 
			...
			MAX_FILE_NUM, MAX_FILE_SIZE, FILE_BASE_ADDRESS, CURRENT_DIR_ADDRESS, ROOT_DIR_ADDRESS);
